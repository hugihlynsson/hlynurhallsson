    ...
    <Frame>
      ...
      <div className="work">
        ...
        <p>
          ...
          München (c. Alexander Steig), 29.03. - 06.05.2018
        </p>
      </div>
      ...
      <div className="work">
        <img src="/images/index/15.jpg" alt="" />
        <p>
          „Reality Check", Reykjavík Art Festival, 15.05. - ­30.06.2010 /
          „Leinen los!", Kunstverein Hannover, 12.06. - ­15.08.2010
        </p>
      </div>
      ...
      <div className="work">
        <img src="/images/index/1.jpeg" alt="" />
        <p>
      ...
      <div className="work">
        <img src="/images/index/2.jpeg" alt="" />
        <p>
          Hlynur Hallsson: Þetta - Das - This, DaLí Gallerí, Akureyri (IS),
          21.09. - 11.10. 2007
        </p>
      </div>

      <div className="work">
        <img src="/images/index/3.jpeg" alt="" />
        <p>
          Skyldi' ég vera þetta sjálfur, Ketilhúsið, Akureyri, 25.08. -
          23.09.2007
        </p>
      </div>

      <div className="work">
        <img src="/images/index/5.jpeg" alt="" />
        <p>
      ...
      <div className="work">
        <img src="/images/index/6.jpeg" alt="" />
        <p>
          Hlynur Hallsson: Ljós - Licht - Light, GalleríBOX, Akureyri (IS),
          10.03. - 25.03.2007
        </p>
      </div>

      <div className="work">
        <img src="/images/index/7.jpeg" alt="" />
        <p>
      ...
      <div className="work">
        <img src="/images/index/10.jpeg" alt="" />
        <p>
